...
AUTHENTICATION_SERVER_REGISTER_REQUEST = "http://{}:{}/user/register".format(AUTHENTICATION_SERVER_HOST, AUTHENTICATION_SERVER_PORT)
...
LOCK_REQUEST = 'http://{}:{}/user/lock'.format(LOCK_SERVER_HOST, LOCK_SERVER_PORT)
UNLOCK_REQUEST = 'http://{}:{}/user/unlock'.format(LOCK_SERVER_HOST, LOCK_SERVER_PORT)
ISLOCK_REQUEST = 'http://{}:{}/user/is-locked'.format(LOCK_SERVER_HOST, LOCK_SERVER_PORT)
